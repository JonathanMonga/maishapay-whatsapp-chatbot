...
type IssuerPaymentMethodMenuScene struct {
	lang string
}

func (s IssuerPaymentMethodMenuScene) Start(bot *chatbot.Bot) {
...
func (s IssuerPaymentMethodMenuScene) saveMobileOperatorAndAskRecipientPhoneNumber(message *chatbot.Notification, paymentMethod string) {
